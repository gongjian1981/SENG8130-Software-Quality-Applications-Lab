...
const DailyViewPage: React.FC<DailyViewProps> = ({
  ...
  const handleDelete = (index: number) => {
    const updated = deleteEvaluation(data, evaluationsForDate, index, filePath);
    onUpdate(updated);
  };
  ...
  const handleSave = () => {
    ...
    const updated = saveOrUpdateEvaluation(
      data,
      evaluationsForDate,
      form,
      date,
    ...
    <div className="max-w-3xl mx-auto p-4 space-y-6">
      ...
      <div className="border p-4 rounded bg-gray-50 space-y-2">
        <h3 className="font-semibold">
          {editingIndex !== null ? 'Edit Evaluation' : 'Add New Evaluation'}
        </h3>
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <select
            ...
            onChange={(e) =>
              setForm({ ...form, 'Evaluation Type': e.target.value })
            }
          >
          ...
          <input
            ...
            onChange={(e) =>
              setForm({ ...form, 'Evaluation Weight': e.target.value })
            }
          />
        </div>
